    ...
    <header>
        <nav class="container">
            ...
            <div class="nav-actions">
                @auth
                    <a href="{{ $profileLink ?? route('student.profile') }}"
    ...
    <div class="container main-wrapper">
        ...
        <div class="content-area">
            @if (session('package_full'))
                <div
                    style="background: #fef2f2; border: 1px solid #fecdd3; color: #b91c1c; padding: 14px 16px; border-radius: 12px; margin-bottom: 20px;">
                ...
                <div class="features-section">
                    ...
                    <ul class="features-list">
                        @foreach ($subjects as $subject)
                            <li class="feature-item">
                                <span class="check-icon">📚</span>
                                <span>{{ $subject->name }} <small
                                        style="color: var(--text-muted); font-weight: 500;">({{ $subject->level }})</small></span>
                            </li>
                        @endforeach
                    </ul>
                </div>
        ...
        <aside class="purchase-card">
            ...
            <div
                style="margin: 10px 0 16px; color: {{ $isFull ? '#b91c1c' : 'var(--text-muted)' }}; font-weight: 600; font-size: 0.95rem;">
            ...
            <div style="text-align: center; margin-top: 12px; font-size: 0.9rem; color: var(--text-muted);">
                Sudah punya akun? <a href="{{ route('login') }}"
                    style="color: var(--primary); font-weight: 600;">Masuk</a>
            </div>
            @endauth
        </aside>
